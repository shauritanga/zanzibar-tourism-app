...
class _RegisterScreenState extends ConsumerState<RegisterScreen> {
  ...
  Future<void> _register() async {
    ...
    try {
      ...
      // Check if email is admin@zanzibar.com
      if (_emailController.text.trim().toLowerCase() == 'admin@zanzibar.com') {
  ...
  String _getReadableErrorMessage(String error) {
    ...
    } else if (error.contains('Admin registration is not allowed')) {
      return 'Admin registration is not allowed. Please contact support.';
